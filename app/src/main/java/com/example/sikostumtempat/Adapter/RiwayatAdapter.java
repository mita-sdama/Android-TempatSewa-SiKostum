...
public class RiwayatAdapter  extends RecyclerView.Adapter<RiwayatAdapter.RiwayatViewHolder> {
    ...
    public  RiwayatAdapter(List<Pemesanan>daftarPemesanan){
    ...
    @Override
    public void onBindViewHolder(@NonNull final RiwayatAdapter.RiwayatViewHolder holder, final int position) {
        ...
        holder.keterangan.setText(daftarPemesanan.get(position).getKeterangan());
        ...
        Integer denda = Integer.parseInt(daftarPemesanan.get(position).getJumlah_denda());
        ...
        holder.jumlah_denda.setText(formatRupiah.format(denda));
    ...
    public class RiwayatViewHolder extends RecyclerView.ViewHolder {
        TextView tvIdTempat,tvNamaUser, email, no_hp, tvAlamat, provinsi, kota, kecamatan, desa, tglTrans,tvNamaKostum,jumlah,hargaKostum,status_log, tgl_sewa, tgl_kembali,total, jumlah_denda, keterangan;
        ...
        public RiwayatViewHolder(@NonNull View itemView) {
            ...
            jumlah_denda = (TextView) itemView.findViewById(R.id.tvDenda);
